...
module "secrets_manager_certificate" {
  ...
  source = "../../../modules/cloud/secrets_manager_certificate"
...
module "openstack_environment" {
  ...
  source = "../../../modules/cloud/os_lb_env"
...
module "openstack_lb_active_standby" {
  ...
  source = "../../../modules/cloud/lb_active_standby"
...
module "openstack_lb_active_standby_with_certificate" {
  ...
  source = "../../../modules/cloud/lb_active_standby_with_certificate"
