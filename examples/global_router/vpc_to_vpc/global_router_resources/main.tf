data "selectel_global_router_zone_v1" "gr_vpc_zone_1" {
  name    = var.region_name1
  service = "vpc"
}

data "selectel_global_router_zone_v1" "gr_vpc_zone_2" {
...
resource "selectel_global_router_vpc_network_v1" "gr_network_11" {
  ...
  zone_id       = data.selectel_global_router_zone_v1.vpc_zone_1.id
...
resource "selectel_global_router_vpc_network_v1" "gr_network_21" {
  router_id     = selectel_global_router_router_v1.gr_router.id
  zone_id       = data.selectel_global_router_zone_v1.vpc_zone_2.id
