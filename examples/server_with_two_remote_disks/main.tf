...
module "server_two_remote_disks" {
  source                        = "../../modules/server_two_remote_disks"
  ...
  server_root_volume_size_gb    = 8
  server_root_volume_type       = "fast.ru-3a"

  server_second_volume_size_gb  = 5
  server_second_volume_type     = "fast.ru-3a"
}
...
resource "openstack_networking_floatingip_associate_v2" "association_1" {
  port_id     = "${module.server_two_remote_disks.server_port_id}"
