# Модуль создания балансировщика базового типа с резервированием и правилом HTTP

Модуль создания балансировщика и его HTTP компонентов с подключениемм к нему плавающего IP адреса.
