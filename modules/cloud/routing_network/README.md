...
## Variables
  ...
  * `selvpc_network_id` - ID of the Selectel Cloud subnet's Network created at Selectel section.

  * `selvpc_subnet_id` - ID of the Selectel Cloud Subnet created at Selectel section.

  * `selvpc_subnet_cidr` -  CIDR of the Selectel Cloud Subnet created at Selectel section.
