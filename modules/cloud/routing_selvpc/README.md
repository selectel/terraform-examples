...
## Outputs
  ...
  * `selvpc_network_id` - ID of the created Selectel Cloud Network.

  * `selvpc_subnet_id` - ID of the created Selectel Cloud Subnet.

  * `selvpc_subnet_cidr` - CIDR of the created Selectel Cloud Subnet.
